...
import pro.upchain.wallet.utils.bip44.hdpath.HdKeyPath;
...
public class HdKeyNode implements Serializable {
     ...
     * @throws KeyGenerationException if the seed is not suitable for seeding an HD wallet key
     ...
     * @throws KeyGenerationException if this is not a private key node, or if no key can be created
     ...
     * @throws KeyGenerationException if this is a public key node which is hardened, or if no key
     ...
     *
     * @throws KeyGenerationException if this is not a private key node
     */
     ...
     * @param network the network the node is to be used on
     * @return a HD wallet key node
     * @throws KeyGenerationException if there is an error parsing the string to a HD wallet key node
